...
class FinancialsdClassificationDataProcessor(DataProcessor):
    """
    Example for a data processor.
    """

    # Set this to the name of the task
    TASK_NAME = "financials"
...
class TrendsClassificationDataProcessor(DataProcessor):
    """
    Example for a data processor.
    """
...
PROCESSORS[FinancialsdClassificationDataProcessor.TASK_NAME] = FinancialsdClassificationDataProcessor
PROCESSORS[TrendsClassificationDataProcessor.TASK_NAME] = TrendsClassificationDataProcessor
