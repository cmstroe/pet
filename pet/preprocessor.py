...
class Preprocessor(ABC):
    ...
    def __init__(self, wrapper, task_name, subj, verb, pattern_id: int = 0,verbalizer_file: str = None):
        """
        ...
        self.pvp = PVPS[task_name](self.wrapper, subj, verb,  pattern_id, verbalizer_file)  # type: PVP
